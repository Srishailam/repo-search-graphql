...
const RepoSearch: React.FC<IProps> = props => {
    const [search, setSearch]:[ISearch, (search:ISearch) => void] = useState({orgName:'',repoName:''});
    const [repo, setRepo]: [IRepo,(repo: IRepo) => void] = useState(defaultRepo);
    const [searchError, setSearchError]: [string,(searchError: string) => void] = useState('');
